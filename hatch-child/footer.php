...
?>
		...
		<div id="footer">
			...
			<div class="footer-content">
                ...
                <p class="copyright">Copyright &#169; <?php echo date('Y'); ?> <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a> | 
				<a href="<?php echo esc_url( home_url( '/imprint' ) ); ?>">imprint</a> | <a href="<?php echo esc_url( home_url( '/privacy' ) ); ?>">privacy</a></p>
